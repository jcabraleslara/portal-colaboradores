    ...
    return `
        <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
            <div style="background-color: #059669; color: white; padding: 20px; text-align: center;">
                <h1 style="margin: 0; font-size: 24px;">âœ… Radicacion Exitosa</h1>
            </div>
            <div style="padding: 30px; background-color: #f9fafb;">
                ...
                <h3 style="color: #059669; border-bottom: 2px solid #d1fae5; padding-bottom: 8px;">ðŸ“‹ Informacion del Paciente</h3>
                <ul style="line-height: 1.8;">
                    <li><strong>Nombre:</strong> ${datos.pacienteNombre}</li>
                    <li><strong>Identificacion:</strong> ${datos.pacienteIdentificacion}</li>
                </ul>
                <h3 style="color: #059669; border-bottom: 2px solid #d1fae5; padding-bottom: 8px;">ðŸ¥ Informacion del Servicio</h3>
                <ul style="line-height: 1.8;">
                ...
                <h3 style="color: #059669; border-bottom: 2px solid #d1fae5; padding-bottom: 8px;">ðŸ“Ž Archivos Adjuntos</h3>
                ${archivosHtml}
                ${oneDriveSection}
                <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0;">
                    <strong>â³ Proximos Pasos:</strong>
        ...
        <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
            ...
            <div style="padding: 30px; background-color: #f9fafb;">
                ...
                <div style="background-color: #fef2f2; border: 3px solid #dc2626; padding: 20px; margin: 20px 0; border-radius: 8px;">
                    <h3 style="color: #dc2626; margin-top: 0; margin-bottom: 10px;">ðŸ“ Observaciones de Facturacion</h3>
                ...
                <h3 style="color: #dc2626; border-bottom: 2px solid #fecaca; padding-bottom: 8px;">ðŸ¥ Informacion del Servicio</h3>
                <ul style="line-height: 1.8;">
                    <li><strong>EPS:</strong> ${datos.eps}</li>
                    <li><strong>Regimen:</strong> ${datos.regimen}</li>
                    <li><strong>Servicio Prestado:</strong> ${datos.servicioPrestado}</li>
                ...
                <h3 style="color: #dc2626; border-bottom: 2px solid #fecaca; padding-bottom: 8px;">ðŸ“… Fechas</h3>
                <ul style="line-height: 1.8;">
                ...
                <h3 style="color: #dc2626; border-bottom: 2px solid #fecaca; padding-bottom: 8px;">ðŸ“Ž Archivos Radicados</h3>
                ${archivosHtml}
                <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0;">
        ...
        <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
            ...
            <div style="padding: 30px; background-color: #f9fafb;">
                ...
                <div style="background-color: #fff7ed; border: 3px solid #ea580c; padding: 20px; margin: 20px 0; border-radius: 8px;">
                    <h3 style="color: #ea580c; margin-top: 0; margin-bottom: 10px;">ðŸ“ Observaciones de Devolucion</h3>
                    <p style="margin: 0; white-space: pre-wrap; line-height: 1.6; color: #7c2d12;">${datos.observacionesDevolucion}</p>
                </div>
                <h3 style="color: #ea580c; border-bottom: 2px solid #fdba74; padding-bottom: 8px;">ðŸ“‹ Informacion del Paciente</h3>
                <ul style="line-height: 1.8;">
                    <li><strong>Tipo de Identificacion:</strong> ${datos.pacienteTipoId}</li>
                    <li><strong>Identificacion:</strong> ${datos.pacienteIdentificacion}</li>
                    <li><strong>Nombre:</strong> ${datos.pacienteNombre}</li>
                </ul>
                <h3 style="color: #ea580c; border-bottom: 2px solid #fdba74; padding-bottom: 8px;">ðŸ¥ Informacion del Servicio</h3>
                <ul style="line-height: 1.8;">
                    <li><strong>EPS:</strong> ${datos.eps}</li>
                    <li><strong>Regimen:</strong> ${datos.regimen}</li>
                    <li><strong>Servicio Prestado:</strong> ${datos.servicioPrestado}</li>
                ...
                <h3 style="color: #ea580c; border-bottom: 2px solid #fdba74; padding-bottom: 8px;">ðŸ“… Fechas</h3>
                <ul style="line-height: 1.8;">
                    <li><strong>Fecha de Radicacion:</strong> ${formatDateTime(datos.fechaRadicacion)}</li>
                    <li><strong>Fecha de Devolucion:</strong> ${formatDateTime(new Date().toISOString())}</li>
                </ul>
                <h3 style="color: #ea580c; border-bottom: 2px solid #fdba74; padding-bottom: 8px;">ðŸ“Ž Archivos Radicados</h3>
                ${archivosHtml}
    ...
    return `
        <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
            <div style="background-color: #4b5563; color: white; padding: 20px; text-align: center;">
                <h1 style="margin: 0; font-size: 24px;">ðŸ“´ Paciente No Contactable</h1>
            </div>
            <div style="padding: 30px; background-color: #f9fafb;">
                <p>Cordial saludo,</p>
                ...
                <div style="background-color: #f3f4f6; border: 3px solid #4b5563; padding: 20px; margin: 20px 0; border-radius: 8px;">
                    <h3 style="color: #374151; margin-top: 0; margin-bottom: 10px;">ðŸ“Œ Informacion del Intento</h3>
                ...
                <div style="background-color: #fff7ed; border-left: 4px solid #f97316; padding: 15px; margin: 20px 0;">
                    <strong>ðŸ”„ Accion Requerida:</strong>
...
function generarTemplateDevolucionRecobro(consecutivo: string, datos: DatosDevolucionRecobro): string {
    ...
    return `
        <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
            <div style="background-color: #dc2626; color: white; padding: 20px; text-align: center;">
                <h1 style="margin: 0; font-size: 24px;">ðŸ”„ Recobro Devuelto</h1>
            </div>
            <div style="padding: 30px; background-color: #f9fafb;">
                <p>Cordial saludo,</p>
...
function generarTemplateAprobacionRecobro(consecutivo: string, datos: DatosAprobacionRecobro): string {
    ...
    return `
        <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
            <div style="background-color: #059669; color: white; padding: 20px; text-align: center;">
                <h1 style="margin: 0; font-size: 24px;">âœ… Recobro Aprobado</h1>
            </div>
            <div style="padding: 30px; background-color: #f9fafb;">
                <p>Cordial saludo,</p>
                ...
                <div style="background-color: #d1fae5; border: 3px solid #059669; padding: 20px; margin: 20px 0; border-radius: 8px; text-align: center;">
                    <h2 style="color: #059669; margin: 0; font-size: 28px;">âœ“ APROBADO</h2>
                ...
                <h3 style="color: #059669; border-bottom: 2px solid #d1fae5; padding-bottom: 8px;">ðŸ¥ Procedimientos Aprobados</h3>
                <table style="width: 100%; border-collapse: collapse; margin: 10px 0;">
                    <thead>
                ...
                <div style="background-color: #ecfdf5; border-left: 4px solid #059669; padding: 15px; margin: 20px 0;">
                    <strong>ðŸ“Œ Informacion Importante:</strong>
...
// Logo Gestar Salud en Base64 (PNG pequeÃ±o optimizado para email)
...
function generarTemplateEnrutado(radicado: string, datos: DatosEnrutado): string {
    const archivosHtml = datos.archivosUrls && datos.archivosUrls.length > 0
        ? `
            <h3 style="color: ${GESTAR_COLORS.primary}; border-bottom: 2px solid ${GESTAR_COLORS.primaryLight}; padding-bottom: 8px;">ðŸ“Ž Documentos Adjuntos</h3>
            <ul style="line-height: 1.8;">
        ...
        <div style="font-family: 'Inter', 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; color: ${GESTAR_COLORS.text}; max-width: 600px; margin: 0 auto; background-color: #ffffff;">
            ...
            <div style="background-color: #1E293B; padding: 20px 30px; text-align: center;">
                ...
                <p style="font-size: 11px; color: #64748B; margin: 12px 0 0 0;">
                    Â© ${new Date().getFullYear()} Gestar Salud de Colombia IPS S.A.S.
                </p>
            </div>
        </div>
    `
