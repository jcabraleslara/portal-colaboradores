...
export function PdfExtractDialog({ isOpen, onClose, onDataExtracted }: PdfExtractDialogProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-hidden">
                {/* Header */}
                ...
                <div className="p-6 overflow-y-auto max-h-[calc(90vh-180px)]">
                    {!archivo ? (
                        ...
                        <div
                            ...
                            className="border-2 border-dashed border-blue-300 dark:border-blue-700 rounded-xl p-12 text-center bg-blue-50 dark:bg-blue-900/20 cursor-pointer hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
                        >
                        ...
                        <div className="space-y-4">
                            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="font-medium text-slate-800 dark:text-slate-100">{archivo.name}</p>
                            ...
                            {resultado && (
                                <div className="bg-slate-50 dark:bg-white/5 rounded-lg p-4 space-y-3">
                                    <div className="flex items-center justify-between">
                                        <h3 className="font-semibold text-slate-700 dark:text-slate-200">Datos extraídos</h3>
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                        ...
                                        {resultado.pacienteNombres && (
                                            <div>
                                                <span className="text-slate-500 dark:text-slate-400">Nombres:</span>
                                        ...
                                        {resultado.medicamentoNombre && (
                                            <div>
                                                <span className="text-slate-500 dark:text-slate-400">Medicamento:</span>
                                                <span className="ml-2 font-medium text-amber-600">{resultado.medicamentoNombre}</span>
                                            </div>
                                        )}
                                        {resultado.concentracion && (
                                            <div>
                                                <span className="text-slate-500 dark:text-slate-400">Concentración:</span>
                                        ...
                                        {resultado.diasTratamiento && (
                                            <div>
                                                <span className="text-slate-500 dark:text-slate-400">Días:</span>
                                                <span className="ml-2 font-medium">{resultado.diasTratamiento}</span>
                                            </div>
                                        )}
                                        {resultado.mesesTratamiento && (
                                            <div className="col-span-2">
                                                <span className="text-slate-500 dark:text-slate-400">Tratamiento:</span>
                                        ...
                                        {resultado.dosisVia && (
                                            <div className="col-span-2">
                                                <span className="text-slate-500 dark:text-slate-400">Posología:</span>
                    ...
                    {/* Error */}
                    {error && (
                        <div className="mt-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 flex items-start gap-3">
