            ...
            >
                ...
                <button
                    ...
                    className={`
                        ...
                        bg-white border border-slate-200 text-slate-400 hover:text-primary-500
                ...
                <div className="flex-1 overflow-y-auto py-5 lg:pt-5 custom-scrollbar">
                    <nav className="px-5 space-y-2" role="navigation">
                        <p className={`
                            px-3 py-2 text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center gap-2
                ...
                <div className={`
                    p-4 bg-white/50 backdrop-blur-sm border-t border-slate-100 overflow-hidden
                    transition-all duration-300
                    ${isCollapsed ? 'p-2' : 'p-4'}
                `}>
                    {!isCollapsed ? (
                        ...
                        <div className="flex flex-col items-center gap-1 py-2">
                            ...
                            <span className="text-[10px] font-bold text-primary-600">v{BUILD_INFO.version}</span>
                        </div>
                    )}
                </div>
            </aside>
